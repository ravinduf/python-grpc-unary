...
import test_unary_pb2 as test__unary__pb2
...
class unaryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                ...
                request_serializer=test__unary__pb2.Message.SerializeToString,
                response_deserializer=test__unary__pb2.MessageResponse.FromString,
                )
...
def add_unaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=test__unary__pb2.Message.FromString,
                    response_serializer=test__unary__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class unary(object):
    ...
    def GetServerResponse(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/unary.unary/GetServerResponse',
            test__unary__pb2.Message.SerializeToString,
            test__unary__pb2.MessageResponse.FromString,
